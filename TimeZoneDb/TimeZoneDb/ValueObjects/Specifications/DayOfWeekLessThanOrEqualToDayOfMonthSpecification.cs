...
{
    public class DayOfWeekLessThanOrEqualToDayOfMonthSpecification : AbstractDayOfMonthSpecification
    {
        #region Ctors
        ...
        /// </param>
        public DayOfWeekLessThanOrEqualToDayOfMonthSpecification(DayOfWeek dayOfWeek, int dayOfMonth)
        {
            DayOfWeek = dayOfWeek;
        ...
        public override int ToDayOfMonth(int year, MonthOfYear month)
        {
            ...
            int daysFromMaxDayOfMonth = 0;
            while (daysFromMaxDayOfMonth < 7)
            {
                int currentDayOfMonth = DayOfMonth - daysFromMaxDayOfMonth++;
